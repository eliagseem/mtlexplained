 ...
 * See the License for the specific language gover2ning permissions and
 * limitations under the License.
 */
'use strict';

MtlExplained.prototype.initTemplates = function() {
  this.templates = {};
...
MtlExplained.prototype.viewHome = function() {
  this.getAllRestaurants();
};

MtlExplained.prototype.viewList = function(filters, filter_description) {
...
MtlExplained.prototype.viewSetup = function() {
  const headerEl = this.renderTemplate('header-base', {
...
MtlExplained.prototype.initReviewDialog = function() {
...
MtlExplained.prototype.initFilterDialog = function() {
...
MtlExplained.prototype.updateQuery = function(filters) {
...
MtlExplained.prototype.viewRestaurant = function(id) {
  let sectionHeaderEl;
...
MtlExplained.prototype.renderTemplate = function(id, data) {
...
MtlExplained.prototype.render = function(el, data) {
  if (!data) return;
...
MtlExplained.prototype.useModifier = function(el, selector, modifier) {
  el.querySelectorAll(`[${selector}]`).forEach(modifier);
};

MtlExplained.prototype.getDeepItem = function(obj, path) {
...
MtlExplained.prototype.renderRating = function(rating) {
...
MtlExplained.prototype.renderPrice = function(price) {
...
MtlExplained.prototype.replaceElement = function(parent, content) {
  parent.innerHTML = '';
  parent.append(content);
};

MtlExplained.prototype.rerender = function() {
