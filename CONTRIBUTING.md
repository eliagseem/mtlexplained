# Contributing to MtlExplained-web
...
As contributors and maintainers of the MtlExplained-web project, we pledge to respect everyone who contributes by posting issues, updating documentation, submitting pull requests, providing feedback in comments, and any other activities.
...
If any member of the community violates this code of conduct, the maintainers of the MtlExplained-web project may take action, removing issues, comments, and PRs or blocking accounts as deemed appropriate.
...
If you have questions about how to use the MtlExplained-web, please open a Github issue. If you need help debugging your own app, please please direct these to [StackOverflow][stackoverflow] and use the `firebase` tag.
...
* Search [GitHub](https://github.com/firebase/MtlExplained-web/pulls) for an open or closed Pull Request
...
* In GitHub, send a pull request to `MtlExplained-web:master`.
